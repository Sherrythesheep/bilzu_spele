...
btn0=Button(width=180,height=180,image=bgImg)
btn1=Button(width=180,height=180,image=bgImg)
btn3=Button(width=180,height=180,image=bgImg)
btn2=Button(width=180,height=180,image=bgImg)
btn4=Button(width=180,height=180,image=bgImg)
btn5=Button(width=180,height=180,image=bgImg)
btn6=Button(width=180,height=180,image=bgImg)
btn7=Button(width=180,height=180,image=bgImg)
btn8=Button(width=180,height=180,image=bgImg)
btn9=Button(width=180,height=180,image=bgImg)
